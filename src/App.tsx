        ...
        {isLocked ? (
          ...
          >
            ...
            <div className="text-center space-y-4 px-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase">Technovo <span className="text-emerald-500">2026 Series 2</span></h1>
              ...
              <header className="flex items-center justify-between border-b border-white/10 pb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-emerald-500 font-mono uppercase tracking-tighter mt-1">Series 2 Inauguration</p>
                  </div>
                </div>
                ...
                <div className="space-y-8 w-full">
                  ...
                  <div className="space-y-4">
                    <h1 className="text-2xl md:text-4xl font-bold tracking-tight text-white/90">
                      {showContent && (
                        <TypingText text="Welcome to Department of computational science" />
                      )}
                    </h1>
